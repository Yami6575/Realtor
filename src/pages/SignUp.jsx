      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto '>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20' >
          <form >
            ...
            <button className='w-full bg-blue-600 text-white mt-8 px-3 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-800 transition duration-150 easy-in-out hover:shadow-lg' type='submit' >Submit</button>
